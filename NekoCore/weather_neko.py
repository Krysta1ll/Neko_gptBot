...
def getweather(city, num):
    ...
    if num == 0:
        ans0 = "喵喵～！明天" + city + "的天气是这样子的喵！明天最高温是【" + tempMax_d1 + "°C】最低温是【" + tempMin_d1 + "°C】。去问了猫猫之神，他说明天白天会是" + textDay_d1 + ",晚上会是" + textnight_d1 + "喵！明天也要加油喵。。。【" + date + "】"
        print(ans0)
        return ans0
    elif num == 3:
        ans3 = "喵喵～！明天晚上将会是" + moonPhase_d1 + "喔！一起去赏月吧喵"
        print(ans3)
        return ans3
    elif num == 4:
